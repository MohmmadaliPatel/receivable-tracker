...
export async function GET(
  ...
  try {
    ...
    const rule = await ForwardingRuleService.getRuleByRecipientId(params.recipientId, user.userId);
...
export async function DELETE(
  ...
  try {
    ...
    await ForwardingRuleService.deleteRule(params.recipientId, user.userId);
